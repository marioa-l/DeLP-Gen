...
parser.add_argument('-all',
                    action='store_true',
                    help='To compute a dataset (generate dataset and compute '\
                            'the metrics)')
...
parser.add_argument('-perc',
                    type=int,
                    help='Percentage of literals to consult per level to'\
                        ' approximate metrics values')
...
# This is for generate a file with all defeaters
